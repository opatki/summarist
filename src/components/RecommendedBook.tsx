...
export default async function RecommendedBook({ type }: {type: string}) {
    ...
    return (
        <div className="flex overflow-hidden gap-4 mb-6 pb-4">
            {data && data.slice(0, 5).map((book: Book) => (
                <Link
                    key={book.id}
                ...
                >
                    ...
                    {book.subscriptionRequired && <div className="absolute top-0 right-0 w-fit h-[18px] px-2 flex items-center bg-[#032b41] text-white text-[10px] rounded-full z-40">
                        Premium
                    </div>}
                    <figure className="w-[172px] h-[172px] mb-2 mx-auto">
                    <img
                    ...
                    <div className="flex gap-2">
                        <div className="flex items-center gap-1 text-sm font-light text-[#6b757b]">
                            ...
                            <svg className="w-full h-full" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex items-center gap-1 text-sm font-light text-[#6b757b]">
                            <div className="flex w-4 h-4">
                            <svg className="w-full h-full" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
