    ...
    return (
        <div className="fixed left-0 top-0 z-[1000] h-screen w-[200px] min-w-[200px] bg-[#f7faf9] transition-all duration-300 ease-in-out">
            ...
            <div className="flex h-[calc(100vh-60px)] flex-col justify-between overflow-y-auto pb-5">
                ...
                <a href="/for-you" className="group mb-2 flex h-14 cursor-pointer items-center text-[#032b41] hover:bg-gray-100 last:mb-0 transition-colors">
                ...
                <a href="/library" className="group mb-2 flex h-14 cursor-pointer items-center text-[#032b41] hover:bg-gray-100 last:mb-0 transition-colors">
                    <div className="mr-4 h-full w-[5px] bg-transparent group-hover:bg-[#032b41]/10"></div>
                    <div className="mr-2 flex items-center justify-center">
                ...
                <a href="/settings" className="group mb-2 flex h-14 cursor-pointer items-center text-[#032b41] hover:bg-gray-100 last:mb-0 transition-colors">
                    <div className="mr-4 h-full w-[5px] bg-transparent group-hover:bg-[#032b41]/10"></div>
                    <div className="mr-2 flex items-center justify-center">
                ...
                <div className="group mb-2 flex h-14 cursor-pointer items-center text-[#032b41] hover:bg-gray-100 last:mb-0 transition-colors">
                    <div className="mr-4 h-full w-[5px] bg-transparent group-hover:bg-[#032b41]/10"></div>
                    <div className="mr-2 flex items-center justify-center">
