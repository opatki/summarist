...
export default function AdjustedSidebar({ font, changeFont }: { font: string, changeFont: (size: string) => void }) {
    ...
    return (
        <div className="fixed left-0 top-0 z-[1000] h-screen w-[200px] min-w-[200px] bg-[#f7faf9] transition-all duration-300 ease-in-out">
            ...
            <div className="flex h-[calc(100vh-60px)] flex-col justify-between overflow-y-auto pb-5">
                ...
                <Link href="/for-you" className="group mb-2 flex h-14 cursor-pointer items-center text-[#032b41] hover:bg-gray-100 last:mb-0 transition-colors">
                ...
                <Link href="/library" className="group mb-2 flex h-14 cursor-pointer items-center text-[#032b41] hover:bg-gray-100 last:mb-0 transition-colors">
                ...
                <div className="flex items-center h-[56px] text-[#032b41] ml-6 gap-2 cursor-pointer mt-[20px] mb-[30px]">
                    <div className={`flex items-center justify-center w-8 h-8 cursor-pointer ${font === "text-base" ? "border-b-[3px] border-[#2bd97c]" : ""}`}
                    onClick={() => changeFont("text-base")}>
                        <svg 
                        stroke="currentColor" 
                        fill="currentColor" 
                        strokeWidth="0" 
                    ...
                    <div className={`flex items-center justify-center w-8 h-8 cursor-pointer ${font === "text-lg" ? "border-b-[3px] border-[#2bd97c]" : ""}`}
                    onClick={() => changeFont("text-lg")}>
                        <svg 
                        stroke="currentColor" 
                        fill="currentColor" 
                        strokeWidth="0" 
                    ...
                    <div className={`flex items-center justify-center w-8 h-8 cursor-pointer ${font === "text-xl" ? "border-b-[3px] border-[#2bd97c]" : ""}`}
                    onClick={() => changeFont("text-xl")}>
                        <svg 
                        stroke="currentColor" 
                        fill="currentColor" 
                        strokeWidth="0" 
                    ...
                    <div className={`flex items-center justify-center w-8 h-8 cursor-pointer ${font === "text-2xl" ? "border-b-[3px] border-[#2bd97c]" : ""}`}
                    onClick={() => changeFont("text-2xl")}>
                        <svg 
                        stroke="currentColor" 
                        fill="currentColor" 
                        strokeWidth="0" 
                ...
                <Link href="/settings" className="group mb-2 flex h-14 cursor-pointer items-center text-[#032b41] hover:bg-gray-100 last:mb-0 transition-colors">
                ...
                <div onClick={handleAuthClick} className="group mb-2 flex h-14 cursor-pointer items-center text-[#032b41] hover:bg-gray-100 last:mb-0 transition-colors">
