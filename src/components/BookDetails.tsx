        ...
        <div className="mx-auto w-full px-4 max-w-[1100px] py-10">
            <div className="flex flex-col gap-10 lg:flex-row">
                ...
                <div className="w-full order-2 lg:order-1">
                    ...
                    <div className="flex gap-4 mb-6">
                        <button onClick={!user.uid ? openModal: book!.subscriptionRequired && !subbed ? () => router.push("/choose-plan") : handleClick} className="flex items-center justify-center w-36 h-12 bg-[#032b41] text-white text-base rounded cursor-pointer gap-2 transition-opacity duration-200 hover:opacity-80 outline-none border-none">
                            <div className="flex">
