"use client"; // This directive allows hooks like useAppSelector
        ...
        <div className="mx-auto w-full px-4 max-w-[1100px] py-10">
            <div className="flex gap-10">
                ...
                <div className="flex gap-4 mb-6">
                    <button onClick={user.uid ? handleRead : openModal} className="flex items-center justify-center w-36 h-12 bg-[#032b41] text-white text-base rounded cursor-pointer gap-2 transition-opacity duration-200 hover:opacity-80 outline-none border-none">
                        <div className="flex">
                    ...
                    <button onClick={user.uid ? handleSave : openModal} className="flex items-center justify-center w-36 h-12 bg-[#032b41] text-white text-base rounded cursor-pointer gap-2 transition-opacity duration-200 hover:opacity-80 outline-none border-none">
                    <div className="flex">
                ...
                <div onClick={user.uid ? handleSave : openModal} className="flex items-center gap-2 text-[#0365f2] font-medium cursor-pointer mb-10 text-lg transition-colors duration-200">
